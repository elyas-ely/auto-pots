...
const api = 'https://swedish-powered-loops-boring.trycloudflare.com/posts/'
...
const users = ['pXtfP6leSwcTp3EEyDVYUio6mvN2', 'R2PKWbicLJMx83aBMKXTt2QvumC3']
...
const sendBulkPosts = async (count) => {
  try {
...
// setInterval(() => sendBulkPosts(80), 5000)
